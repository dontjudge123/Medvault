document.addEventListener('DOMContentLoaded', function () {
    ...
    // Additional features or enhancements can be added here

    // Example: Display a notification after 5 seconds
    setTimeout(function () {
        alert('Welcome to MedVault! Your trusted platform for managing health records.');
    }, 5000);
});
...
document.getElementById('patientForm').addEventListener('submit', function (event) {
    ...
    simulateAsyncSubmission();
});

function simulateAsyncSubmission() {
    setTimeout(function () {
        // Replace this with actual AJAX or fetch API call
